...
<div class="main-v1-3-shell" data-agent-left={p4OnLeft} data-agent-focus={agentFocus}>
  ...
  <main id="main-row" class:agent-left={p4OnLeft} class="main-row">
    <aside id="p0" class:hidden={!p0Visible} class="panel p0">
      ...
      <button id="log" class="rail-item icon-btn" type="button" title="Log">
      ...
      <button id="refresh" class="rail-item icon-btn" type="button" title="Refresh">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <button id="setting" class="rail-item icon-btn" type="button" title="Settings">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
